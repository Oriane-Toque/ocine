 ...
 */
final class Version20210722133154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD rating SMALLINT DEFAULT NULL, CHANGE duration duration SMALLINT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP rating, CHANGE duration duration INT NOT NULL');
    }
}
